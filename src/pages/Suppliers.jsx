...
function Suppliers() {
  ...
  const [suppliers, setClients] = useState([]);
  ...
  return (
    <div className="w-3/4 md:w-2/3 mx-auto p-12">
      <SearchToolForm
        ...
        placeholder={" Enter you Supplier Name "}
      />
          ...
          <tbody>
            {filteredSuppliers?.map((supplier) => (
              <tr key={supplier.id} className="bg-white border-b">
                ...
                <td className="px-6 py-4">{supplier.Supplier_RC}</td>
                <td className="px-6 py-4">{supplier.Supplier_NIF}</td>
                <td className="px-6 py-4">{supplier.Supplier_NIS}</td>
                <td className="px-6 py-4">{supplier.Supplier_Phone}</td>
                <td className="px-6 py-4">{supplier.Supplier_Email}</td>
                <td className="px-6 py-4">{supplier.Supplier_Adress}</td>
...
const SupplierModal = ({ onClose }) => {
  const handleSubmit = (event) => {
    ...
    // Populate supplierData object with form values
    formData.forEach((value, key) => {
      supplierData[key] = value;
    });
